...
void main() {
  group('Firestore Integration Test', () {
    test('Subir curso', () async {
      ...
      print(
          'El test de "Subir curso" se realizó correctamente. Validación de creación correcta.');
    });
    test('Subir unidad', () async {
      ...
      print(
          'El test de "Subir unidad" se realizó correctamente. Validación de creación correcta.');
    });
    test('Guardar seguimiento', () async {
      ...
      print(
          'El test de "Guardar seguimiento" se realizó correctamente. Validación de creación correcta.');
    });
  });
}
