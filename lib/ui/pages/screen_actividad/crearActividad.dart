                  ...
                  children: [
                                ...
                                SizedBox(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      prefixIcon:
                                          Icon(Icons.text_fields, color: blueColor),
                    ...
                    Padding(
                      ...
                      child: PixelLargeBttn(
                        ...
                        onPressed: () {
                          setState(() {
                            board = List.generate(36,
                                (index) => -1); // Restablece la matriz en blanco
                          });
                        },
           ...
           padding: EdgeInsets.only( left: 20, right: 20),
            ...
            const SizedBox(height: 50),
                    const TitleText(
                                ...
                                const SizedBox(height: 40),
                                const ParagraphText(
                                    text: 'Arrastra y suelta los elementos al Mapa para construir la actividad'),
                                    const SizedBox(height: 20),
                    Wrap(
              children: elements
                      .asMap()
